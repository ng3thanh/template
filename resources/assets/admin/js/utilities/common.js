...
var slugCommon = function () {
    var convertSlug = function convertSlug(title, slug) {
    ...
    function stringToSlug(str) {
        ...
        var from = "đàáảạâầấẩậăằắẳặèéẻẹêếềểệìíîỉịòóỏöọôốồổộơớờởợùúủụưứừửựüûñç·/_,:;";
        var to   = "daaaaaaaaaaaaaaeeeeeeeeeiiiiiooooooooooooooouuuuuuuuuuunc------";

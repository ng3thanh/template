    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Create new new</h3>
            </div>
            <div class="box-body">
                <form role="form" id="create-new-new" class="form-horizontal" action="{{ route('new.store') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="col-xs-12">
                        <!-- Custom Tabs -->
                            ...
                            <div class="tab-content">
                                ...
                                <div class="button-list col-lg-12">
                                    <div class="col-lg-8 col-lg-offset-2">
                                        <div class="col-lg-3">
                                            <button class="btn btn-block btn-default" form="create-new-new" type="submit">Create</button>
                                        </div>
                                        <div class="col-lg-offset-1 col-lg-3">
                                            <button class="btn btn-block btn-default" form="create-new-new" type="reset">Reset</button>
                                        </div>
                                        <div class="col-lg-offset-1 col-lg-3">
...
@section('script')
    ...
    <script>
        $(function () {
            ...
            FormUtil.validate('#create-new-new');
            slugCommon.convertSlug(titleEn, slugEn);
            slugCommon.convertSlug(titleVn, slugVn);

            $('#create-new-new').on('keyup keypress', function(e) {
